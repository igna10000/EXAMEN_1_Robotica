...
#ifndef INTERFACE__SRV__DETAIL__AIBO__FUNCTIONS_H_
#define INTERFACE__SRV__DETAIL__AIBO__FUNCTIONS_H_
...
/// Create srv/Aibo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface__srv__Aibo_Request__init().
...
/// Destroy srv/Aibo message.
/**
 * It calls
 * interface__srv__Aibo_Request__fini()
...
/// Check for srv/Aibo message equality.
/**
...
/// Initialize array of srv/Aibo messages.
/**
...
/// Finalize array of srv/Aibo messages.
/**
 * It calls
 * interface__srv__Aibo_Request__fini()
...
/// Create array of srv/Aibo messages.
/**
 * It allocates the memory for the array and calls
 * interface__srv__Aibo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Aibo messages.
/**
 * It calls
 * interface__srv__Aibo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Aibo message array equality.
/**
...
/// Copy an array of srv/Aibo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface__srv__Aibo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It calls
 * interface__srv__Aibo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It allocates the memory for the array and calls
 * interface__srv__Aibo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface
...
/**
 * It calls
 * interface__srv__Aibo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACE__SRV__DETAIL__AIBO__FUNCTIONS_H_
